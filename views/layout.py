...
def create_layout() -> html.Div:
    ...
    return html.Div(
        [
            ...
            dcc.Store(id="bookings-store", storage_type="session", data=[]),
            ...
            dcc.Store(id="notifications-store", storage_type="session", data=[]),
            dcc.Store(id="active-floor-store", storage_type="memory", data=0),
